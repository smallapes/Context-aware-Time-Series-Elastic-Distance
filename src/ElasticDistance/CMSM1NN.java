...
public class CMSM1NN extends Efficient1NN {
    ...
    public CMSM1NN(double c,double step){
        this.step = step;
        this.c = c;
        this.classifierIdentifier = "CMSM_1NN";
    ...
    public double distance(Instance first, Instance second, double cutOffValue) {
        ...
        for (int i = 1; i < m; i++) {
            ...
            for (int j = 1; j < n; j++) {
                ...
                list_im1.add(first.value(Math.min(i+step-1,m-1)));
...
//        String datasetName = "BME";
        ...
        // new version
        CMSM1NN msmNew = new CMSM1NN(c,0.05);
    ...
    public static void UCR2018(){
        boolean cv = true;
        Efficient1NN dtwNew = new CMSM1NN();
        dtwNew.cparamId = 5;
