...
import timeseriesweka.elastic_distance_measures.CDTW_DistanceBasic;
...
public class CDD_DTW extends kNN implements SaveParameterInfo{
    ...
    public CDD_DTW(DistanceType distType){
        super();
    ...
    //        DTW dtw = new DTW();
            CDTW_DistanceBasic dtw = new CDTW_DistanceBasic();
            int classPenalty = 0;
            if(first.classIndex()>0){
                classPenalty=1;
            }
...
//            ed = new GoreckiEuclideanDistance();
            ...
            //DD_ED
            CDD_DTW dd_ed = new CDD_DTW(DistanceType.EUCLIDEAN);
            ...
            // DDDTW
            CDD_DTW dd_dtw = new CDD_DTW(DistanceType.DTW);
    ...
    public static void main(String[] args){
        ...
        try{
            if(option==1){
                ...
                CDD_DTW nndw = new CDD_DTW(DistanceType.DTW);;
