...
public class CMSM1NNFastSavePath extends Efficient1NN{
    ...
    public CMSM1NNFastSavePath(double c, double step){
        this.step = step;
        this.c = c;
        this.classifierIdentifier = "CMSM_1NN";
...
//        String datasetName = "BME";
        ...
        // new version
        CMSM1NNFastSavePath msmNew = new CMSM1NNFastSavePath(c,0.05);
    ...
    public static void UCR2018(){
        boolean cv = true;
        Efficient1NN dtwNew = new CMSM1NNFastSavePath();
        dtwNew.cparamId = 5;
