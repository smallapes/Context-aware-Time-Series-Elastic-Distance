 ...
 * L =[1,2,3,4,5]
 */
public class CDTWCV1NNConv2 extends Efficient1NN {
    private double r;
    private double step;
    private int L;
     ...
     * @param r
     */
    public CDTWCV1NNConv2(double r){
...
//        String datasetName = "SonyAiboRobotSurface1";
        ...
        // new version
        CDTWCV1NNConv2 dtwNew = new CDTWCV1NNConv2(r);
    ...
    public static void UCR2018(){
        ...
        Efficient1NN dtwNew = new CDTWCV1NNConv2();
