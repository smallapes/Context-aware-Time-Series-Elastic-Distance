 ...
 */
public class CDTWF1NN extends Efficient1NN {
    ...
    public CDTWF1NN(double r, double step){
        this.allowLoocv = false;
        this.r = r;
        if(r!=1){
            this.classifierIdentifier = "DTW_Rn_1NN";
...
//        String datasetName = "SonyAiboRobotSurface1";
        ...
        // new version
        CDTWF1NN dtwNew = new CDTWF1NN(r);
    ...
    public static void UCR2018(){
        double r = 1;
        boolean cv = false;
        Efficient1NN dtwNew = new CDTWF1NN(r);
        //dtwNew.turnOnCV();
        //this.cparamId = 10;
    ...
    public static void UCR2018SavePath(){
        double r = 1;
        Efficient1NN dtwNew = new CDTWF1NN(r,0.05);
        boolean cv =false;
