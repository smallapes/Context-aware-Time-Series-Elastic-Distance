 ...
 *   g =0.1 banSize =0.1 step = 0.5
 */
public class CERPNoCV1NN extends Efficient1NN{
    ...
    public CERPNoCV1NN(double g, double bandSize) {
        this.g = g;
...
//        oldDtw.setR(r);
        ...
        // new version
        CERPNoCV1NN dtwNew = new CERPNoCV1NN(0.1, 0.1);
    ...
    public static void UCR2018(){
        double r = 1;
        boolean cv = false;
        Efficient1NN dtwNew = new CERPNoCV1NN(0.1,0.1);
        //dtwNew.turnOnCV();
        //this.cparamId = 10;
