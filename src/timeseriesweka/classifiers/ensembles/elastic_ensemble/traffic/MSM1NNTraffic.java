...
public class MSM1NNTraffic extends Efficient1NNTraffic{
    ...
    public MSM1NNTraffic(){
        this.c = 0.1;
        this.classifierIdentifier = "MSM_1NN";
    }

    public MSM1NNTraffic(double c){
        this.c = c;
        this.classifierIdentifier = "MSM_1NN";
...
//        String datasetName = "Coffee";
        ...
        // new version
        MSM1NNTraffic msmNew = new MSM1NNTraffic(c);
    ...
    public static void UCR2018(){
        boolean cv = true;
        Efficient1NNTraffic dtwNew = new MSM1NNTraffic();
        dtwNew.cparamId = 5;
