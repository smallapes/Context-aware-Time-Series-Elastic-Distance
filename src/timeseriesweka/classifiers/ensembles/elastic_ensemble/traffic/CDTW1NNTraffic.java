...
public class CDTW1NNTraffic extends Efficient1NNTraffic {
     ...
     * @param r
     */
    public CDTW1NNTraffic(double r){
    ...
    public CDTW1NNTraffic(double r, double step){
        this.allowLoocv = false;
        this.r = r;
        if(r!=1){
            this.classifierIdentifier = "DTW_Rn_1NN";
...
//        }
        ...
        int m = second.numAttributes()-1;
        if(isTraffic){
            n = (int) first.value(trafficFeatLen+1);
            m = (int) second.value(trafficFeatLen+1);
        }
...
//        String datasetName = "SonyAiboRobotSurface1";
        ...
        // new version
        CDTW1NNTraffic dtwNew = new CDTW1NNTraffic(r);
    ...
    public static void UCR2018(){
        double r = 1;
        boolean cv = false;
        Efficient1NNTraffic dtwNew = new CDTW1NNTraffic(r);
        //dtwNew.turnOnCV();
        //this.cparamId = 10;
    ...
    public static void UCR2018SavePath(){
        double r = 1;
        Efficient1NNTraffic dtwNew = new CDTW1NNTraffic(r,0.05);
        boolean cv =false;
