 ...
 * @author sjx07ngu
 * @author:tcl
 * not used becase erp might can be optimized too
 */
//public class MSM1NN implements Classifier{
@SuppressWarnings("all")
public class MSM1NNFast extends Efficient1NN{
    ...
    public double distance(Instance first, Instance second, double cutOffValue) {
        ...
        double dist =0;
        double new_point, x, y;
        for (int i = 1; i < m; i++) {
            new_point = first.value(i);
            x = first.value(i-1);
            y = second.value(0);
...
//        String datasetName = "Coffee";
        ...
        // new version
        MSM1NNFast msmNew = new MSM1NNFast(c);
    ...
    public static void UCR2018(){
        boolean cv = true;
        Efficient1NN dtwNew = new MSM1NNFast();
        //this.cparamId = 10;
