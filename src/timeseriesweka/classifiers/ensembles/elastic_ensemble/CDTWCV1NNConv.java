 ...
 */
public class CDTWCV1NNConv extends Efficient1NN {
    private double r;
    private double step;
    private int L;
...
//        String datasetName = "SonyAiboRobotSurface1";
        ...
        // new version
        CDTWCV1NNConv dtwNew = new CDTWCV1NNConv(r);
    ...
    public static void UCR2018(){
        ...
        Efficient1NN dtwNew = new CDTWCV1NNConv();
