...
//        String datasetName = "Coffee";
        ...
        ERPDistance oldDtw = new ERPDistance(0.1, r);
//        oldDtw.setR(r);
        knn.setDistanceFunction(oldDtw);
        knn.buildClassifier(train);
        
        // new version
        ERP1NN dtwNew = new ERP1NN();
    ...
    public static void UCR2018(){
        double r = 1;
        boolean cv = true;
        Efficient1NN dtwNew = new ERP1NN();
        //dtwNew.turnOnCV();
        //this.cparamId = 10;
    ...
    public void setParamsFromParamId(Instances train, int paramId) {
        if(!this.gAndWindowsRefreshed){
            ...
            for(int i =0;i<gValues.length;i++)
                System.out.println("gValues:\t"+gValues[i]);
            for(int i =0;i<windowSizes.length;i++)
                System.out.println("windowSizes:\t"+windowSizes[i]);
        }
