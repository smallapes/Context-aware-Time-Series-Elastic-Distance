 ...
 * @author sjx07ngu
 */
public class CLCSS1NN extends Efficient1NN{
    ...
    public CLCSS1NN(int delta, double epsilon){
        this.delta = delta;
        ...
        for(int i = 0; i < m; i++){
            for(int j = i-delta; j <= i+delta; j++){
                if(j < 0){
                    ...
                    j = i+delta;
                    /*
                    Math.sqrt(Math.pow(first.value(Math.max(i-step,0))-second.value(Math.max(j-step,0)),2)+
                        Math.pow(first.value(i)-second.value(j),2)+
                        Math.pow(first.value(Math.min(i+step,m-1))-second.value(Math.min(j+step,n-1)),2))<3*this.delta
                     */
                    /*
                    Math.abs(first.value(Math.max(i-step,0))-second.value(Math.max(j-step,0)))+
                        Math.abs(first.value(i)-second.value(j))+
                        Math.abs(first.value(Math.min(i+step,m-1))-second.value(Math.min(j+step,n-1)))<3*this.delta
                     */
                }else if(
                        Math.abs(first.value(Math.max(i-step,0))-second.value(Math.max(j-step,0)))+
                                Math.abs(first.value(i)-second.value(j))+
                                Math.abs(first.value(Math.min(i+step,m-1))-second.value(Math.min(j+step,n-1)))<3*this.epsilon){
...
//        String datasetName = "SonyAiboRobotSurface1";
        ...
        // new version
        CLCSS1NN lcssNew = new CLCSS1NN(delta, epsilon);
