 ...
 * @author tcl
 *
 * to observe what effect different step have on the accuracy ?
 * step = [0, 0.01,...,0.99]
 *
 */
public class CDTWCV1NNStep extends Efficient1NN {
    private double r;
    private double step;
...
//        String datasetName = "SonyAiboRobotSurface1";
        ...
        // new version
        CDTWCV1NNStep dtwNew = new CDTWCV1NNStep(r);
    ...
    public static void UCR2018(){
        boolean cv = true;
        Efficient1NN dtwNew = new CDTWCV1NNStep();
        dtwNew.cparamId = 10;
...
//            UCR2018();
    ...
    public void setParamsFromParamId(Instances train, int paramId) {
        if(this.allowLoocv){
            ...
            this.step = 1 * ((double)paramId/this.cparamId);
