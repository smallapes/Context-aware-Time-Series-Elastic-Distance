 ...
 * Drop context point exceed border
 *
 */
public class CDTWCV1NNDrop extends Efficient1NN {
    private double r;
    private double step;
    private int L;
...
//        String datasetName = "SonyAiboRobotSurface1";
        ...
        // new version
        CDTWCV1NNDrop dtwNew = new CDTWCV1NNDrop(r);
    ...
    public static void UCR2018(){
        boolean cv = true;
        Efficient1NN dtwNew = new CDTWCV1NNDrop();
        dtwNew.cparamId = 10;
...
//            UCR2018StepAnalyze();
    ...
    public void setParamsFromParamId(Instances train, int paramId) {
        if(this.allowLoocv){
            ...
            this.step = 0.1 * ((double)paramId/this.cparamId);
            System.out.println(this.getParamInformationString());
