...
public class CMSM1NNFast extends Efficient1NN{
    ...
    public CMSM1NNFast(double c, double step){
        this.step = step;
        this.c = c;
        this.classifierIdentifier = "CMSM_1NN";
...
//        String datasetName = "BME";
        ...
        // new version
        CMSM1NNFast msmNew = new CMSM1NNFast(c,0.05);
    ...
    public static void UCR2018(){
        boolean cv = true;
        Efficient1NN dtwNew = new CMSM1NNFast();
        dtwNew.cparamId = 5;
