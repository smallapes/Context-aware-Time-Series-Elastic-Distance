...
public class HiveCotePostProcessed extends AbstractPostProcessedCote{
    ...
    public static void main(String[] args) throws Exception{
        ...
        Instances train = loadData(tscProbDir+datasetName+"/"+datasetName+"_TRAIN");
//
        Instances test = loadData(tscProbDir+datasetName+"/"+datasetName+"_TEST");
        /*
...
//                        hcpp = new HiveCotePostProcessed("C:/3xsshare/Jay/LocalWork/coteConstituentResultsgress/", datasetName, resample, classifiersToUse);
                        hcpp = new HiveCotePostProcessed("D:/硕士培养手册/小论文/results/coteConstituentResults/", datasetName, resample, classifiersToUse);
                        hcpp.setAlpha(alpha);
                        hcpp.useVotes();
